...
const getAllArticles = async () => {
  const erkekFutbolRes = await fetch(
...
const buildFeed = (items) => {
  const feed = new Feed({
    ...
    description:
      "Fenerbahçe son dakika transfer haberleri, son dakika spor haberleri ve diğer branşlardan tüm güncel haberler",
...
export default function RssPage3() {}
