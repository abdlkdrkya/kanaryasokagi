...
export default function FutbolPuanDurumu({ puanDurumu, profile }) {
  ...
  return (
    <Layout>
      <Head>
        <title>Fenerbahçe Erkek Futbol Puan Durumu | Kanaryasokağı | Fenerbahçe haberlerinin tek adresi</title>
             <meta charSet="utf-8" />
          <meta name="viewport" content="width=device-width, initial-scale=1" />
			  <meta name="title" content="Fenerbahçe Erkek Futbol Puan Durumu | Kanaryasokağı | Fenerbahçe haberlerinin tek adresi"/>
			<meta name="description" content="Fenerbahçe Erkek Futbol Takımı'nın En Güncel Puan Durumu. "/>
			<meta name="keywords" content="kanaryasokağı, fenerbahçe Erkek Futbol, fenerbahçe futbol, fenerbahçe, fenerbahçe Puan Durumu, fenerbahçe futbol Puan Durumu"/>
			<meta name="revisit-after" content="3 days"/>
          <link rel="icon" href="/kanaryasokagi.ico" />
		  <link rel="apple-touch-icon" href="/kanaryasokagi.ico"/>
	    <link rel="canonical" href="https://kanaryasokagi.com/puan-durumu/futbol"/>
      </Head>
                ...
                <Table.Header className="xxs:text-2xs xs:text-xxs sm:text-xs md:text-sm lg:text-tiny xl:text-base 2xl:text-lg">
                  <Table.Row>
                    ...
                    <Table.HeaderCell textAlign="center">
                      <Popup
                        content="Attığı Gol"
                        trigger={<Icon name="futbol" color="green" />}
                      />
                    </Table.HeaderCell>
                    <Table.HeaderCell textAlign="center">
                      <Popup
                        content="Yediği Gol"
                        trigger={<Icon name="futbol" color="red" />}
                      />
                    </Table.HeaderCell>
