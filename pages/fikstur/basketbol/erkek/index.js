import Layout from"../../../../components/layout";import Image1 from"next/image";import Head from"next/head";import{Table}from"semantic-ui-react";import{Grid}from"semantic-ui-react";import AdSense from "react-adsense";import{useEffect}from"react";import{absoluteUrl,getAppCookies,verifyToken}from"../../../../middleware/utils";import{useContext}from"react";import{AuthContext}from"../../../../contexts/AuthProvider";
export default function ErkekBasketbolFikstur({ fikstur, profile }) {
 const{status:status,user:user}=useContext(AuthContext);useEffect(()=>{let leg;void 0!==profile.email?(user.setUserDetails({id:profile.id,email:profile.email,username:profile.username,firstname:profile.firstname,lastname:profile.lastname,roleId:profile.roleId,profile:profile.profile,isBanned:profile.isBanned}),status.setLoggedIn(!0)):status.setLoggedIn(!1)},[profile]);
  return (
    <Layout>
      <Head>
        <title>
          Fenerbahçe Erkek Basketbol Fikstur - Kanaryasokağı - Fenerbahçeye dair
        </title>
        <meta charSet="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="title"
          content="Fenerbahçe Erkek Basketbol Fikstur - Kanaryasokağı - Fenerbahçeye dair"
        />
        <meta
          name="description"
          content="Fenerbahçe Erkek Basketbol Takımı'nın En Güncel Fiksturü. "
        />
        <meta
          name="keywords"
          content="kanaryasokağı, fenerbahçe erkek Basketbol, fenerbahçe Basketbol, fenerbahçe beko, fenerbahçe fikstürü, fenerbahçe erkek Basketbol fikstürü, fenerbahçe Basketbol fikstürü"
        />
