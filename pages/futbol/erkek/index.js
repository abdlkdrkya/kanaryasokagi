  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="Fenerbahçe Erkek Futbol Takımı son dakika transfer haberleri, son dakika  Erkek Futbol Takımı haberleri ve diğer branşlardan tüm güncel haberler"
        />
        <meta
          name="keywords"
                ...
                <Grid.Column width={16}>
                  ...
                  <div className="w-full px-0">
                    <Swiper
                      ...
                      slidesPerView={5}
                      autoplay={false}
                      className="mt-2 h-14 sm:h-16 md:h-16 lg:h-20 xl:h-24"
                      id="swiperThumbs"
                    >
                      {futbolKategori.data.slice(0, 5).map((haber) => (
                        <SwiperSlide
              ...
              <Grid.Row>
                <Grid.Column computer={5} tablet={5} mobile={16}>
                  <div className="space-y-4">
                    {futbolKategori.data.slice(5, 8).map((haber, index) => (
                      <div
                        id="normalAltHaber"
                  ...
                  >
                    ...
                    /></div>
                    {futbolKategori.data.slice(8, 10).map((haber, index) => (
                      <div
                        id="normalAltHaber"
                        className="w-full shadow-xl cursor-pointer xxs:px-4 xs:px-4 sm:px-4 md:px-0 lg:px-0 xl:px-0 2xl:px-0"
                        key={index}
                ...
                <Grid.Column computer={5} tablet={5} mobile={16}>
                  <div className="space-y-4">
                    {futbolKategori.data.slice(15, 16).map((haber, index) => (
                      <div
                        id="normalAltHaber"
                        className="w-full shadow-xl cursor-pointer xxs:px-4 xs:px-4 sm:px-4 md:px-0 lg:px-0 xl:px-0 2xl:px-0"
                        key={index}
                  ...
                  >
                    <AdSense.Google
                      ...
                      layoutKey="-gw-1+2a-9x+5c"
                    /></div>
                    {futbolKategori.data.slice(16, 20).map((haber, index) => (
                      <div
                        id="normalAltHaber"
                        className="w-full shadow-xl cursor-pointer xxs:px-4 xs:px-4 sm:px-4 md:px-0 lg:px-0 xl:px-0 2xl:px-0"
                        key={index}
                  ...
                  <Grid.Row centered style={{ marginTop: 4 }}>
                    <Grid.Column mobile={16} tablet={5} computer={5}>
                      <DynamicComponentWithCustomLoading
                        data={futbolKategori.data.slice(20, 21)}
                      /><div
                      className="w-full shadow-xl cursor-pointer xxs:px-4 xs:px-4 sm:px-4 md:px-0 lg:px-0 xl:px-0 2xl:px-0"
                    >
                      <AdSense.Google
                      ...
                      /></div>
                      <DynamicComponentWithCustomLoading
                        data={futbolKategori.data.slice(21, 25)}
                      />
                    </Grid.Column>
                    <Grid.Column mobile={16} tablet={5} computer={5}>
                      <DynamicComponentWithCustomLoading
                        data={futbolKategori.data.slice(25, 27)}
                      /><div
                      className="w-full shadow-xl cursor-pointer xxs:px-4 xs:px-4 sm:px-4 md:px-0 lg:px-0 xl:px-0 2xl:px-0"
                    >
                      <AdSense.Google
                      ...
                      /></div>
                      <DynamicComponentWithCustomLoading
                        data={futbolKategori.data.slice(27, 30)}
                      />
                    </Grid.Column>
                    <Grid.Column mobile={16} tablet={5} computer={5}>
                      <DynamicComponentWithCustomLoading
                        data={futbolKategori.data.slice(30, 34)}
                      /><div
                      className="w-full shadow-xl cursor-pointer xxs:px-4 xs:px-4 sm:px-4 md:px-0 lg:px-0 xl:px-0 2xl:px-0"
                    >
                      <AdSense.Google
                      ...
                      /></div>
                      <DynamicComponentWithCustomLoading
                        data={futbolKategori.data.slice(34, 35)}
                      />
                    </Grid.Column>
                  </Grid.Row>
                </Grid>
              ...
              {inView2 && (
                <Grid centered style={{ marginTop: 4 }}>
                  <Grid.Row>
                    <Grid.Column computer={5} tablet={5} mobile={16}>
                      <DynamicComponentWithCustomLoading
                        data={futbolKategori.data.slice(35, 40)}
                      />
                    </Grid.Column>
                    <Grid.Column computer={5} tablet={5} mobile={16}>
                      <DynamicComponentWithCustomLoading
